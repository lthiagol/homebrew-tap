...
You should see a version like `0.2.0-dev.<date>`, e.g. `0.2.0-dev.20260719`.
...
`lazybrew` (stable) is auto-bumped on tag push via `mislav/bump-homebrew-formula-action`. Keeping `lazybrew-dev` on a separate, manually-maintained formula means:
